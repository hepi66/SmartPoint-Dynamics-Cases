...
[PROJECT_PLAN.md](PROJECT_PLAN.md) is the authoritative source for roadmap, progress, completed work, and next steps. All implementation items are initially NOT STARTED.
